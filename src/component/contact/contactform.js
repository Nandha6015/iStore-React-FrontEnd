  ...
  render() {
    ...
    if (!formValid) {
      return (
        <>
          <div
            className="card shadow-lg border-0 px-3 py-1 rounded-2 mb-4 py-4 mx-auto mt-2 bg-light"
            id="contact-card"
          >
            ...
            <div className="card-body">
              ...
              >
                ...
                <div className="form-group">
                  <label className="pb-2">Your contact number (Optional)</label>
                  <input
                    name="contact"
                    type="text"
                    className="form-control mb-2"
                ...
                <p className="text-center px-5 pt-3">
                  <input
                    type="submit"
                    className="btn btn-yellow btn-lg w-100 text-uppercase"
                    value="Submit Now"
                  />
                </p>
              </form>
